  ...
  <div class="md:hidden sm:flex rounded-box">
    <div class="relative">
      <div class="navbar-end flex w-full">
        <div class="flex-1">
          <a href="base-path/index.html" class="btn btn-ghost text-xl w-20"><img class="w-[30px]" src="../images/FondoGiListo.png" alt=""></a>
        </div>
        <div class="dropdown">
          ...
          <ul tabindex="0" class="menu menu-sm dropdown-content z-[40] p-2 shadow bg-base-100 rounded-box absolute top-full right-2
                w-auto min-w-min max-w-screen-lg 
                ">
                <li><a href="base-path/#nosotros">INICIO</a></li>
                <li><a href="base-path/#services">PRODUCTOS</a></li>
                <li><a href="base-path/#contacto">NOSOTROS</a></li>                
          </ul>
        </div>
      </div>
    </div>
